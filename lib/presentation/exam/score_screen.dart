...
//                               (viewModel.answerEntity?.correct?.toDouble() ?? 0) /
//                                   (viewModel.questions?.questions?.length ?? 1),  // Safely handling null
//                               (viewModel.answerEntity?.wrong?.toDouble() ?? 0) /
//                                   (viewModel.questions?.questions?.length ?? 1),  // Safely handling null
//                             ),
//                           ),
//                           Text(
...
//                                 ? double.tryParse(viewModel.answerEntity?.total?.replaceAll('%', '') ?? "0") ?? 0.0
//                                 : (viewModel.answerEntity?.total as double?) ?? 0.0)
//                                 .toStringAsFixed(0), // Round to 0 decimal places
                      ...
                      Stack(
                        ...
                        children: [
                          CustomPaint(
                            size: Size(120.w, 120.h),
                            painter: ScorePainter(
                              (viewModel.answerEntity?.correct?.toDouble() ??
                                      0) /
                                  (viewModel.questions?.questions?.length ?? 1),
                              (viewModel.answerEntity?.wrong?.toDouble() ?? 0) /
                                  (viewModel.questions?.questions?.length ?? 1),
                            ),
                          ),

...
// class _ProfileTabState extends State<ProfileTab> {
//   late EditProfileViewModel viewModel;
//   late LoginResponseEntity userData;
//   late ProfileUserEntity profileUserData;
//
//   @override
//   void initState() {
//     super.initState();
...
//   }
//
//   void _populateUserData(LoginResponseEntity user) {
//     viewModel.userNameController.text = user.user?.username ?? '';
//     viewModel.firstNameController.text = user.user?.firstName ?? '';
//     viewModel.lastNameController.text = user.user?.lastName ?? '';
//     viewModel.emailController.text = user.user?.email ?? '';
//     viewModel.phoneController.text = user.user?.phone ?? '';
//   }
//
//   @override
//   Widget build(BuildContext context) {
...
//         },
//         builder: (context, state) {
//           return _buildProfileForm(viewModel, state);
//         },
//       ),
//     );
//   }
//
//   Widget _buildProfileForm(EditProfileViewModel viewModel, EditProfileState state) {
//     return SingleChildScrollView(
//       child: Form(
//         key: viewModel.formEditProfileKey,
//         child: Column(
...
//               child: Text(
//                 "Profile",
//                 style: getTextStyle(FontSize.s20, FontWeightManager.medium, ColorsManager.blackColor),
//               ),
//             ),
//             SizedBox(height: 16.h),
//             const CustomPickerImage(),
...
//                   "Change",
//                   textAlign: TextAlign.center,
//                   style: getTextStyle(FontSize.s12, FontWeightManager.semiBold, ColorsManager.primaryColor),
//                 ),
//               ),
//             ),
//             SizedBox(height: 16.h),
